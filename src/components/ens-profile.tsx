  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex justify-between mt-6">
        ...
        <Link href="/graph" className="text-blue-600 hover:underline text-sm font-medium">
          View Graph →
        </Link>
      </div>
    </div>
  ...
  return (
    <div>
      ...
      <div className="relative">
        {/* Header/Banner Image */}
        <div 
          className="h-32 bg-gradient-to-r from-blue-400 via-blue-500 to-cyan-400"
        ...
        <div className="absolute -bottom-12 left-6">
          {profile.avatar ? (
            ...
            <div className="w-24 h-24 rounded-full border-4 border-white bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center shadow-lg">
      ...
      {Object.values(accounts).some(Boolean) && (
        <div className="px-6 pb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {accounts.discord && (
              <span className="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg text-sm">
                <span>🎮</span>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors text-sm group"
            >
            ...
            {Object.entries(profile.textRecords).map(([key, value]) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-2 p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded opacity-0 group-hover:opacity-100 transition-all"
                >
                  {copiedText === key ? (
      ...
      {profile.address && (
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg group">
            <div>
              <span className="text-sm text-blue-600 font-medium">eth</span>
              <p className="text-sm text-gray-700 font-mono mt-0.5">{profile.address}</p>
            </div>
            <button
              onClick={() => handleCopy(profile.address!, "eth-record")}
              className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded opacity-0 group-hover:opacity-100 transition-all"
            >
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-mono">{truncateAddress(profile.address)}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 rounded">Manager</span>
              <span className="px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 rounded">ETH record</span>
            </div>
          </div>
        </div>
      )}
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="text-xs text-gray-400 pt-4 border-t">
        <p>📡 Data fetched directly from Ethereum Mainnet via RPC. All records are read from the ENS resolver contract on-chain.</p>
      </div>
    </div>
  );
}
